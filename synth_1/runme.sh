...
HD_PWD='/home/mohit/Desktop/bheeshm_project/bheeshm_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zed_firewall_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zed_firewall_wrapper.tcl
