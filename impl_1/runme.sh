...
HD_PWD='/home/mohit/Desktop/bheeshm_project/bheeshm_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zed_firewall_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zed_firewall_wrapper.tcl -notrace
